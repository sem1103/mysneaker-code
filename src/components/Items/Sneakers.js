      ...
      <div>
        ...
        <div className='add__btn'>
          <button onClick={
            ...
            <img src={isAdded ? '../../../img/addedBtn.png' : '../../../img/addBtn.png'} alt='Btn'/>
          </button>
        </div>
      </div>
    </div>
